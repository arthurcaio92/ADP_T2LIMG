...
from ADP_T2LIMG.ADP_T2LIMG.T2FTS import FuzzySet, tri_mf, IT2FS_plot, min_t_norm, max_s_norm, TR_plot, crisp
from ADP_T2LIMG.ADP_T2LIMG.T2FTS import Type2Model
